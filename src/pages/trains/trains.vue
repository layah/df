    ...
    <div class="zk_homebg">
      ...
      <div class="couse_list_box Mtp20" v-for="(couseList,index) in couseList">
        <div class="p_ibt wido25 Mtp20 Mlf15 Mrt25 fl">
          <a class="p_ibt posr" href="javascript:;">
      ...
      <div class="table">
        <div class="table_cell">
          <div class="scaleBox_cont p_ibt Tleft F0 posr" style="min-height:600px;">
            <div class="Mtp30 Mlf25 Mbm30 p_ibt wido65 ">
...
export default{
    components:{
     ...
     data() {
        return {
            add:"/#/integratedCase",
            headslogo:"/src/assets/images/logo2.png",
            name:"企业综合案例",
            title:'企业综合案例',
            protject:{},
            titlelist:[],
    ...
    watch: {
     ...
     methods: {
            ...
            // ------------------------------
                ...
                // $(".trabtn-icon:first").css({"background":"#1a9bfc"});
