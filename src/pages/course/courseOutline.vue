<template>
  <div class="couser_basis">
    ...
    <div class="auto_box">
      <div class="couse_title Center F40 color_3 Line40 Mbm40" v-text="couseTitle"></div>
      <div class="couse_list_box Mtp20" v-for="(couseList,index) in couseList">
        ...
        <ul class="F0 couses_icon_box ">
          <li class="p_ibt Mrt60" v-for="(couseICon,index) in couseList.couseICon">
            <div class="couses_icon " :class="'couses_icon_'+(index+1)" :data-num="(index+1)">
                ...
                <div class="tabel Center ">
                  <div class="thead ">
                    <div class="color_f F0">
                      <div class="p_ibm wido30 Tleft F14 bor_right Plf25">章节名称</div>
                  ...
                  <div class="t_body">
                    <div class="t_row F0" v-for="(chapterNm,index) in  chapter.chapterNm">
                      <div class="p_ibm wido30 Tleft F14 bor_right ">
                        <span class="Plf25">{{"0"+(index+1) | index}}</span>
                        <span class="Mlf10">{{chapterNm.chapName}}</span>
                      </div>
      ...
      <div class="table">
        <div class="table_cell">
          <div class="scaleBox_cont p_ibt Tleft F0 posr" style="min-height:600px;">
            <div class="Mtp30 Mlf25 Mbm30 p_ibt wido65 videoBox" >
              <video id="example_video_1"  controls preload="none" width="100%" height="100%">
            </div>
